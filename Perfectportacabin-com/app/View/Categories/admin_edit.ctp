...
<div class="form-group">
			...
			<div class="col-md-4">
			 <label class="radio-inline">
			<input type="radio" name="data[Category][top_business_category]" value="1" <?php if($this->data['Category']['top_business_category'] == 1) { echo 'checked'; } ?>>
			<span>Yes</span></label>
			<label class="radio-inline">
			<input type="radio" name="data[Category][top_business_category]" value="0" <?php if($this->data['Category']['top_business_category'] == 0) { echo 'checked'; } ?>>
			<span>No</span></label>
