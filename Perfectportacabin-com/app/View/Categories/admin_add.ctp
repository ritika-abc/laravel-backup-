			  ...
			  <label class="control-label col-md-2">Select Parent Category</label>
			   ...
			   <div class="form-group">
                ...
                <div class="col-md-4">
					 ...
					 <?php echo $this->Form->input('category_title', array('class'=>'form-control col-md-3','label'=>'','empty' => true));?>	
                </div>
               
                <label class="control-label col-md-2">Category Order</label>
                <div class="col-md-1">
				 
					 <?php echo $this->Form->input('category_order', array('class'=>'form-control col-md-3','label'=>'', 'min' => '0'));?>	
                </div>
              </div> 
...
<input type="file" name="data[Category][image]" id="BannerThumb">
			...
			<input type="radio" name="data[Category][active]" value="1">
			<span>Active</span></label>
			<label class="radio-inline">
			<input type="radio" name="data[Category][active]" value="0">
			<span>Inactive</span></label>
			 
			</div>
			 
			<label class="control-label col-md-2">Top Business Category</label>
			<div class="col-md-4">
			 <label class="radio-inline">
			<input type="radio" name="data[Category][top_business_category]" value="1">
			<span>Yes</span></label>
			<label class="radio-inline">
			<input type="radio" name="data[Category][top_business_category]" value="0">
			<span>No</span></label>
			...
			<div class="form-group">
			   ...
			   <div class="form-group">
				...
				<?php 
				   ...
				   array( 'controller' => 'categories', 'action' => 'index', $parent_id, 'admin' => true),
