   ...
   <div class="row">
      <div class="col-lg-12">
         <div class="widget-container fluid-height clearfix">
            <div class="heading"> <i class="icon-reorder"></i>Client Details </div>
            <div class="widget-content padded">
               <?php echo $this->Form->create('Ourclient',array('enctype'=>'multipart/form-data','class' => 'form-horizontal'));
               ...
               <?php
                  $thumbImageurl = $this->Html->url('/images/ourclients/'.$this->data['Ourclient']['image']);
                  $Imageurl = "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image";
                  
                  $Imageurl = ($this->data['Ourclient']['image'] != '')?$thumbImageurl:$Imageurl;
                  ?>
               <div class="form-group">
                  ...
                  <div class="col-md-4">
                     <div class="fileupload fileupload-new" data-provides="fileupload">
                        ...
                        <div> <span class="btn btn-default btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span>
                           <input type="file" name="data[Ourclient][image]" id="BlogThumb">
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-7">
                     ...
                     <?php 
                        ...
                        array( 'controller' => 'ourclients', 'action' => 'index', 'admin' => true),
