...
<div class="container-fluid main-content">
		...
		echo $this->Form->input('id');
          ...
          ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Banner][name]" maxlength="255" type="text" value="<?php echo $this->data['Banner']['name'];?>" class="form-control" id="BannerName">
			   ...
			   <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Banner][page_url]" maxlength="255" type="text" value="<?php echo $this->data['Banner']['page_url'];?>"  class="form-control" id="BannerName">
                ...
                <div class="col-md-7">
 				  <input name="data[Banner][description]" maxlength="255" type="text" class="form-control" id="BannerName" value="<?php echo $this->data['Banner']['description'];?>">
 ...
 <div class="form-group">  <div class="col-md-2"></div>
 	<div class="col-md-7">	<?php //echo $this->Html->image('upload_images/'.$this->data['Banner']['thumb'], array('alt' => $this->data['Banner']['name'], 'width' => 100, 'height' => 100));?>
</div>
</div>
