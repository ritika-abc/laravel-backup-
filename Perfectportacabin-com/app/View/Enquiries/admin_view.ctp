<div class="container-fluid main-content">
          ...
          <div class="widget-content padded">            
			 ...
			 <div class="form-group clearfix">
			  ...
			  <?php } ?>
                ...
                <div class="col-md-9">
				 <?php echo h($enquiry['Enquiry']['country']); ?>					 	
                </div>
              </div> 
		 
			   <?php /* if($enquiry['Enquiry']['category_id'] != '0') { ?>
			   <div class="form-group clearfix">
                <label class="control-label col-md-2">Category</label>
                <div class="col-md-9">
				 <?php echo h($enquiry['Enquiry']['category_id']); ?>					 	
                </div>
              </div> 
			  <?php } */ ?>
			  
			  <?php if($enquiry['Enquiry']['company'] != '') { ?>
			  <div class="form-group clearfix">
                <label class="control-label col-md-2">Company Name</label>
                <div class="col-md-9">
				 <?php echo h($enquiry['Enquiry']['company']); ?>					 	
                </div>
              </div> 
			   <?php } ?>
   ...
   <div class="form-group clearfix">
                <label class="control-label col-md-2">Form Request </label>
                <div class="col-md-9">
				 <?php echo h($enquiry['Enquiry']['formrequest']); ?>					 	
                </div>
              </div> 	  
