      ...
      <div class="col-lg-12">
        <div class="widget-container fluid-height clearfix">
          ...
          <div class="widget-content padded">
             <?php echo $this->Form->create('Video',array('enctype'=>'multipart/form-data','class' => 'form-horizontal'));
		echo $this->Form->input('id');
          ...
          ?>
		    <div class="form-group">
                ...
                <div class="col-md-7">
 				<input name="data[Video][description]" maxlength="255" type="text" value="<?php echo $this->data['Video']['description'];?>" class="form-control" id="BannerName">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Video][name]" maxlength="255" type="text" value="<?php echo $this->data['Video']['name'];?>" class="form-control" id="BannerName">
			   ...
			   <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Video][video_url]" maxlength="255" type="text" value="<?php echo $this->data['Video']['video_url'];?>"  class="form-control" id="BannerName">
