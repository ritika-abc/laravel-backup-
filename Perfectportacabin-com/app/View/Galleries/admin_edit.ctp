		...
		echo $this->Form->input('id');
          ...
          ?>
		    <div class="form-group">
                ...
                <div class="col-md-7">
 				<input name="data[Gallery][description]" maxlength="255" type="text" value="<?php echo $this->data['Gallery']['description'];?>" class="form-control" id="BannerName">
                </div>
              </div>
...
<div class="form-group">
			   ...
			   <?php
				...
				$thumbImageurl = $this->Html->url('/images/galleries/'.$this->data['Gallery']['image2']);
				$Imageurl = "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image";
				
				$Imageurl = ($this->data['Gallery']['image2'] != '')?$thumbImageurl:$Imageurl;
				?>
...
<div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="fileupload fileupload-new" data-provides="fileupload">
                    ...
                    <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 200px; max-height: 150px"></div>
                    <div> <span class="btn btn-default btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span>
 					  <input type="file" name="data[Gallery][image2]" id="BannerThumb">
                      </span><a class="btn btn-default fileupload-exists" data-dismiss="fileupload" href="#">Remove</a> </div>
                  </div>
                </div>
              </div> 
			   ...
			   <?php
				...
				$thumbImageurl = $this->Html->url('/images/galleries/'.$this->data['Gallery']['image3']);
				$Imageurl = "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image";
				
				$Imageurl = ($this->data['Gallery']['image3'] != '')?$thumbImageurl:$Imageurl;
				?>
...
<div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="fileupload fileupload-new" data-provides="fileupload">
                    ...
                    <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 200px; max-height: 150px"></div>
                    <div> <span class="btn btn-default btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span>
 					  <input type="file" name="data[Gallery][image3]" id="BannerThumb">
                      </span><a class="btn btn-default fileupload-exists" data-dismiss="fileupload" href="#">Remove</a> </div>
                  </div>
                </div>
              </div> 
