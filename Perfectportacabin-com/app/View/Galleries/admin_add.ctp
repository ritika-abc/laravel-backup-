...
<div class="container-fluid main-content">
   ...
   <!--<div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Gallery][name]" maxlength="255" type="text" class="form-control" id="BannerName">
			   ...
			   <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Gallery][page_url]" maxlength="255" type="text" class="form-control" id="BannerName">
...
<div class="form-group">
				...
				?>
			   <div class="form-group">
                <label class="control-label col-md-2">Image_2</label>
                <div class="col-md-4">
                  <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;"> <img src="<?php echo $Imageurl;?>"> </div>
                    <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 200px; max-height: 150px"></div>
			  ...
			  <?php
				...
				?>
			   <div class="form-group">
                <label class="control-label col-md-2">Image_3</label>
                <div class="col-md-4">
                  <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;"> <img src="<?php echo $Imageurl;?>"> </div>
                    <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 200px; max-height: 150px"></div>
		   ...
		   array( 'controller' => 'galleries', 'action' => 'index', $product_id, 'admin' => true),
