...
<?php echo $this->Form->create('Setting'); ?>
	...
	<?php
		...
		echo $this->Form->input('new_address2');
		echo $this->Form->input('new_address3');
		echo $this->Form->input('new_address4');
		echo $this->Form->input('new_number');
		echo $this->Form->input('company_number1');
		...
		echo $this->Form->input('skype_url');
