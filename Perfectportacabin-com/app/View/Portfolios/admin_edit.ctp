    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="widget-container fluid-height clearfix">
          <div class="heading"> <i class="icon-reorder"></i>Gallery Details </div>
...
<div class="form-group">
                ...
                <div class="col-md-7">
 									 <?php echo $this->Form->input('name1', array('class'=>'form-control col-md-3','label'=>''));?>	
              ...
              <div class="form-group">
			   ...
			   <div class="form-group">
                ...
                <div class="col-md-7">
 				  <input name="data[Portfolio][page_url]" maxlength="255" type="text" value="<?php echo $this->data['Portfolio']['page_url'];?>"  class="form-control" id="PortfolioName">
 ...
 <div class="form-group">  <div class="col-md-2"></div>
 	<div class="col-md-7">	<?php //echo $this->Html->image('upload_images/'.$this->data['Portfolio']['thumb'], array('alt' => $this->data['Portfolio']['name'], 'width' => 100, 'height' => 100));?>
</div>
</div>
 		 
				<?php
				
				$thumbImageurl = $this->Html->url('/images/portfolios/'.$this->data['Portfolio']['image']);
				$Imageurl = "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image";
				
				$Imageurl = ($this->data['Portfolio']['image'] != '')?$thumbImageurl:$Imageurl;
				?>
