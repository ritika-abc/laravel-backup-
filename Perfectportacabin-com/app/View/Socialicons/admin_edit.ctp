		...
		echo $this->Form->input('id');
          ...
          ?> 
        	...
        	<div class="form-group">
				...
				$imageImageurl = $this->Html->url('/images/sitepages/'.$this->data['Socialicon']['image']);
				$Imageurl = "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image";
				
				$Imageurl = ($this->data['Socialicon']['image'] != '')?$imageImageurl:$Imageurl;
				?>


				 
                <label class="control-label col-md-2">Socialicon Image</label>
                <div class="col-md-4">
                  <div class="fileupload fileupload-new" data-provides="fileupload">
                    ...
                    <div> <span class="btn btn-default btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span>
 					  <input type="file" name="data[Socialicon][image]" id="BannerThumb">
			  	 ...
			  	 <div class="form-group">
				 <label class="control-label col-md-2">Icon Css2</label>
                <div class="col-md-4"> 				
 				   			<?php echo $this->Form->input('iconcss2', array('class' => 'form-control col-md-3' ,'label'=>'')); ?>
                </div> 
              </div>
